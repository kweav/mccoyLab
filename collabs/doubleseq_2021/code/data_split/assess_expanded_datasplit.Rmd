...
## Read in metadata from expanded batch 3 split
```{r}
#including from batch2
#full_meta_withSet <- read.csv("~/mccoyLab/collabs/doubleseq_2021/tidied_meta/meta_withSet_kw_20220308.csv", row.names = 1)

full_meta_withSet <- read.csv("~/mccoyLab/collabs/doubleseq_2021/tidied_meta/meta_withSet_kw_20220613.csv", row.names = 1)
